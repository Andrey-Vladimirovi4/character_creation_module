...
def attack(char_name, char_class):
    if char_class == 'warrior':
        return (f'{char_name} нанёс урон противнику равный {5 + rnd(3, 5)}')
    if char_class == 'mage':
        return (f'{char_name} нанёс урон противнику равный {5 + rnd(5, 10)}')
    if char_class == 'healer':
        return (f'{char_name} нанёс урон противнику равный {5 + rnd(-3, -1)}')
    return (f'{char_name} не нанёс урон')


def defence(char_name, char_class):
    if char_class == 'warrior':
        return (f'{char_name} блокировал {10 + rnd(5, 10)} урона')
    if char_class == 'mage':
        return (f'{char_name} блокировал {10 + rnd(-2, 2)} урона')
    if char_class == 'healer':
        return (f'{char_name} блокировал {10 + rnd(2, 5)} урона')
...
def start_training(char_name, char_class):
    intro = '''Введи одну из команд: attack — чтобы атаковать противника,
...
def choice_char_class():
    approve_choice = None
    char_class = None
    profs = '''Введи название персонажа, за которого хочешь играть:
     Воитель — warrior, Маг — mage, Лекарь — healer: '''
    while approve_choice != 'y':
        char_class = input(profs)
        if char_class == 'warrior':
